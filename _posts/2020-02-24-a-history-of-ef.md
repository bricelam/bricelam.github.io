...
2021 | [EF Core 6.0](https://docs.microsoft.com/ef/core/what-is-new/ef-core-6.0/plan) planned (perf improvements, JSON, compiled models, value objects, migration bundles, temporal tables, custom conventions)
